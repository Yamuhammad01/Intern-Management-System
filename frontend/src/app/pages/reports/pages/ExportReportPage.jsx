...
function ExportReportPage({ navigate, reportType = "intern" }) {
  ...
  return (
    <main className="flex-1 overflow-y-auto">
      {/* Sub-topbar */}
      <div className="bg-white border-b border-gray-100 px-4 sm:px-6 py-3 flex flex-wrap items-center justify-between gap-2 sticky top-0 z-10">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 sm:py-1.5 rounded-lg border border-gray-200 text-[12.5px] font-medium text-gray-600 hover:bg-gray-50 transition-colors shrink-0"
        >
